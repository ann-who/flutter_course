...
class OrderItem extends StatelessWidget {
  ...
  const OrderItem({required this.cartCubit, required this.order, super.key});
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            const Spacer(),
            InkWell(
              onTap: () => cartCubit.decreaseProduct(order.product),
              child: const AppIcon(
            ...
            InkWell(
              onTap: () => cartCubit.addProduct(order.product),
              child: const AppIcon(
